...
export default function LoginScreenAnimation({onComplete}) {
    ...
    return (
        <div className='fixed inset-0 z-50 bg-black text-gray-100 flex flex-col
    items-center justify-center gap-5'>
            <div className='w-[300px] h-[3px] bg-gray-800 rounded relative overflow-hidden'>
                <div className='w-[40%] h-full bg-blue-500 shadow-[0_0_15px_#4179e3]
