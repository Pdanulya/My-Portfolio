  ...
  return (
    ...
    >
      ...
      <div className='max-w-6xl mx-auto px-4'>
        <h2 className='text-5xl sm:text-4xl md:text-5xl font-semibold mb-12 bg-gradient-to-r from-teal-500 to-indigo-600
        bg-clip-text text-transparent text-center'>
            About Me
        </h2>
        <div className='p-6 sm:p-8 mb-6 rounded-xl border-white/10 border-2 hover:-translte-y-1 transition-all'>
